...
ICMS_table20 <- read_excel("ICMS_TOTAL_2022.xlsx", 
                         sheet = "ICMS", 
                         col_types = c("text", "text", "numeric", "text", "numeric"))


#renomear a coluna
colnames(ICMS_table20) <- c('Tipo', 'Grupo', 'data','Ano', 'Valor')
...
rm(df_19,df_20, df_data19,df_data20, tabela_19,tabela_20)
...
rm(df_data, df_data21,df_data22, tabela_21, tabela_22,tabela_211, tabela_21a,
   tabela_222,tabela_22a)
