...
ICMS_table <- read_excel("ICMS_TOTAL_2022.xlsx", 
  ...
  setNames(c('tipo','grupo', 'data', 'datax', 'valor')) %>%
  select(tipo,grupo, data, valor) %>% 
...
rm(table_22, table21, table_21_pass)