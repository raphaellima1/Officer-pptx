...
source( encoding = 'UTF-8', file = 'ICMS_TOTAL_2022.R')

# definir o primeiro grupo - TOTAIS
grupo <- variaveis[1]
...
my <- read_pptx('blank.pptx') %>% 
  ...
  ph_with(block_list(fpar(ftext(glue("COMPORTAMENTO DIÁRIO DA ARRECADAÇÃO"), 
...
setwd("./Flextable/")
source( encoding = 'UTF-8', file = 'table_setor.R')


my <- my %>%
  add_slide(layout = "Título e conteúdo", master = "Tema do Office") %>% 
  
  ph_with(block_list(fpar(ftext('ICMS - TOTAL', 
...
my <- my %>%
  ...
  # Titulo e subtitulo
  ph_with(block_list(fpar(ftext(glue('ICMS - {grupo}'), 
                                prop = fp_text(font.size = 18, 
                                               color = "#2d2e2d")), 
                          fp_p = border1)),
...
################################################################################
setwd("./Flextable/")
source( encoding = 'UTF-8', file = 'tabela_variacao.R')
...
################################################################################
setwd("./Flextable/")
source( encoding = 'UTF-8', file = 'cat_tab_real.R')
...
setwd("./Gráficos/")
source( encoding = 'UTF-8', file = 'plots_mensal.R')
...
for (i in 2:11) {
  ...
  setwd("./Tabela/")
  source( encoding = 'UTF-8', file = 'tranformacao_tables19_a_22.R')
...
my %>%
  print(target = glue("{dia}- ICMS.pptx"))%>% 
  browseURL()


rm(border, border1, border2)
